...
public abstract class GenericDAO<T> {
     ...
     * 
     * @param tipo
     *  O tipo do objeto deve ser criado e preenchido com os valores do banco
  ou inseridos no banco
     * 
     * @param connection 
     *  Contém as configurações para criar a conexão com o banco
     */
     ...
     * 
     * verdadeiro, se for usado o "?" do PreparedStatment no lugar do nome da variavel campo
     * 
     * @return 
     */
